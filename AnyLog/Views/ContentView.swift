...
let sampleMeals: [Meal] = [
    Meal(mealType: .breakfast,
         ...
         time: Date(year:   2025, month: 11, day: 15, hour: 19, minute: 15)),
    
    Meal(mealType: .lunch,
         content: "닭가슴살 샐러드와 coffee",
         date: Date(year: 2025, month: 10, day: 15),
         time: Date(year: 2025, month: 10, day: 15, hour: 19, minute: 25)),
    ...
    Meal(mealType: .snack,
         content: "요거트와 블루베리",
         date: Date(year: 2025, month: 10, day: 15),
         time: Date(year: 2025, month: 10, day: 15, hour: 19, minute: 0)),
    
    Meal(mealType: .breakfast,
         content: "오트밀과 바나나",
         date: Date(year: 2025, month: 10, day: 14),
         time: Date(year: 2025, month: 10, day: 14, hour: 19, minute: 50)),
    
    Meal(mealType: .lunch,
         content: "비빔밥과 미역국",
         date: Date(year: 2025, month: 10, day: 14),
         time: Date(year: 2025, month: 10, day: 14, hour: 19, minute: 10)),
    ...
    Meal(mealType: .snack,
         content: "아몬드 한 줌",
         date: Date(year: 2025, month: 10, day: 14),
         time: Date(year: 2025, month: 10, day: 14, hour: 19, minute: 30)),
    
    Meal(mealType: .breakfast,
         content: "스크램블에그와 오렌지 주스",
         date: Date(year: 2025, month: 10, day: 13),
         time: Date(year: 2025, month: 10, day: 13, hour: 19, minute: 5)),
